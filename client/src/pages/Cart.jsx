...
import { FaTrash, FaArrowRight, FaShoppingBag, FaTag } from "react-icons/fa";
    ...
    if (cartItems.length === 0) {
        return (
            <div className="min-h-screen bg-stone-50 flex flex-col items-center justify-center px-4">
                <FaShoppingBag size={48} className="text-stone-300 mb-4" />
                ...
                <Link
                    to="/"
                    className="flex items-center gap-2 px-6 py-3 bg-zinc-900 text-white rounded-xl font-bold text-sm hover:bg-zinc-800 transition-all active:scale-95"
                >
        ...
        <div className="min-h-screen bg-stone-50 py-8 px-4">
            <div className="max-w-5xl mx-auto">
                ...
                <div className="flex items-center justify-between mb-6">
                    ...
                    <button
                        onClick={clear}
                        className="flex items-center gap-1.5 text-xs text-red-400 font-bold hover:text-red-600 border border-red-200 bg-red-50 px-3 py-2 rounded-xl transition-all"
                    >
                    ...
                    <div className="flex-1 space-y-3">
                        {cartItems.map(item => {
                            ...
                            return (
                                <div
                                    key={item._id}
                                    className="bg-white rounded-2xl border border-stone-200 shadow-sm p-4 flex items-center gap-4"
                                >
                                    {/* Image */}
                                    ...
                                    <div className="text-right shrink-0">
                                        ...
                                        <button
                                            ...
                                            className="text-red-400 text-xs font-bold hover:text-red-600 mt-1 transition-colors"
                                        >
                                            Remove
                                        </button>
                                    </div>
                    ...
                    <div className="lg:w-80 shrink-0">
                        <div className="bg-white rounded-2xl border border-stone-200 shadow-sm p-5 sticky top-24">
                            ...
                            <div className="space-y-3 text-sm">
                                ...
                                {savingsOnDelivery > 0 && (
                                    <p className="text-emerald-600 text-xs font-bold text-center bg-emerald-50 rounded-xl py-2">
                                        🎉 You're saving ₹{savingsOnDelivery} on delivery!
                                    </p>
                                )}
                            </div>
